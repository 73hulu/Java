Java提供了几种能有效组织和操作数据的数据结构，这些数据机构通常称为Java集合框架。在Java开发过程中，灵活熟练地使用这些集合框架，可以明显地提高我们的开发效率，当然仅仅是会用还是不够的，理解其中的设计思想与原理才能更好地提高我们的开发水平。
# 概述
...
![java_container](../../img/java_container.png)
