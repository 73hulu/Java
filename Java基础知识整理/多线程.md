...
|  受影响的线程 |  当前线程 | 在该对象上wait的线程  |在该对象上wait的所有线程   |  当前线程  | 当前线程   | 当前线程   |
