...
* [源码解读](源码解读/introduction.md)
    ...
    * [java.util](源码解读/java.util/java-util.md)
        ...
        * [StringJoiner](源码解读/java.util/StringJoiner.md)
...
* 设计模式
    * [Principle](DesignPattern/Principle/Principle.md)
        ...
        * [接口隔离原则](DesignPattern/Principle/Interface.md)
        * [迪米特法则](DesignPattern/Principle/Demeter.md)
        * [开闭原则](DesignPattern/Principle/Open.md)
    * [设计模式](DesignPattern/DesignPattern/DesignPattern.md)
        * [创建型模式](DesignPattern/DesignPattern/Creation/Creation.md)
            * [Abstract Factory](DesignPattern/DesignPattern/Creation/Abstract Factory.md)
            * [Factory Method](DesignPattern/DesignPattern/Creation/Factory Method.md)
            * [Singleton](DesignPattern/DesignPattern/Creation/Singleton.md)
            * [Builder](DesignPattern/DesignPattern/Creation/Builder.md)
            * [Prototype](DesignPattern/DesignPattern/Creation/Prototype.md)
        * [结构型模式](DesignPattern/DesignPattern/Structure/Structure.md)
            * [Adapter](DesignPattern/DesignPattern/Structure/Adapter.md)
            * [Bridge](DesignPattern/DesignPattern/Structure/Bridge.md)
            * [Composite](DesignPattern/DesignPattern/Structure/Composite.md)
            * [Decorator](DesignPattern/DesignPattern/Structure/Decorator.md)
            * [Facade](DesignPattern/DesignPattern/Structure/Facade.md)
            * [Flyweight](DesignPattern/DesignPattern/Structure/Flyweight.md)
            * [Proxy](DesignPattern/DesignPattern/Structure/Proxy.md)
        * [行为型模式](DesignPattern/DesignPattern/Behaviour/Behaviour.md)
            * [Chain of Responsibility](DesignPattern/DesignPattern/Behaviour/Chain of Responsibility.md)
            * [Interpreter](DesignPattern/DesignPattern/Behaviour/Interpreter.md)
            * [Template Method](DesignPattern/DesignPattern/Behaviour/Template Method.md)
            * [Command](DesignPattern/DesignPattern/Behaviour/Command.md)
            * [Iterator](DesignPattern/DesignPattern/Behaviour/Iterator.md)
            * [Mediator](DesignPattern/DesignPattern/Behaviour/Mediator.md)
            * [Memento](DesignPattern/DesignPattern/Behaviour/Memento.md)
            * [Observer](DesignPattern/DesignPattern/Behaviour/Observer.md)
            * [State](DesignPattern/DesignPattern/Behaviour/State.md)
            * [Strategy](DesignPattern/DesignPattern/Behaviour/Strategy.md)
            * [Visitor](DesignPattern/DesignPattern/Behaviour/Visitor.md)
...
* 常用工具
    * [FastJson](Utils/FastJson.md)
    * [Gson](Utils/Gson.md)
    * [Google Guava](Utils/Google Guava/Google Guava.md)
        * [Base](Utils/Google Guava/Base/Base.md)
            * [Ascii](Utils/Google Guava/Base/Ascii.md)
            * [CaseFormat](Utils/Google Guava/Base/CaseFormat.md)
            * [CharMatcher](Utils/Google Guava/Base/CharMatcher.md)
            * [Joiner](Utils/Google Guava/Base/Joiner.md)
            * [Splitter](Utils/Google Guava/Base/Splitter.md)
            * [Strings](Utils/Google Guava/Base/Strings.md)
            * [Function](Utils/Google Guava/Base/Function.md)
            * [Functions](Utils/Google Guava/Base/Functions.md)
            * [Predicate](Utils/Google Guava/Base/Predicate.md)
            * [Predicates](Utils/Google Guava/Base/Predicates.md)
            * [Equivalence](Utils/Google Guava/Base/Equivalence.md)
            * [Converter](Utils/Google Guava/Base/Converter.md)
            * [Supplier](Utils/Google Guava/Base/Supplier.md)
            * [Optional](Utils/Google Guava/Base/Optional.md)
            * [Stopwatch](Utils/Google Guava/Base/Stopwatch.md)
            * [Preconditions](Utils/Google Guava/Base/Preconditions.md)
        * [Collection](Utils/Google Guava/Collection/Collection.md)
* 错题集
    * [错题集1](错题集/错题集1.md)
    * [错题集2](错题集/错题集2.md)
    * [错题集3](错题集/错题集3.md)
